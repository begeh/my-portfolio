...
<div class="row">
  <h2 class="col-xs-4 text-center header-border"><a href="#toabout" class="scroll-links">ABOUT</a>
  </h2>
  <h2 class="col-xs-4 text-center header-border"><a href="#toprojects" class="scroll-links">
  PROJECTS
  </h2></a>
  <h2 class="col-xs-4 text-center header-border"><a href="#tocontact" class="scroll-links">
  CONTACT
    </h2></a>
...
<h2 class="h2"><a name="toabout"></a> ABOUT ME</h2>
  ...
  <div>
<!--Put in placeholders for my project section-->
